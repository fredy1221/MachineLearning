...
from tensorflow.python.keras.api.keras.optimizers import Adam
from tensorflow.python.keras.api.keras.utils import to_categorical
from tensorflow.python.keras.api.keras.layers import Dropout, Flatten
from tensorflow.python.keras.api.keras.layers import Conv2D, MaxPooling2D
import cv2
